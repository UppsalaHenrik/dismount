...
#' @param paramsToCompare A vector of two parameter names following the NONMEM ext file standard names. Default is c("THETA1", "THETA2"). Parameters to compare. Model file cannot currently use labels for parameters.
